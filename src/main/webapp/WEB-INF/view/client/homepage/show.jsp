                        ...
                        <div class="owl-carousel vegetable-carousel justify-content-center">
                            <div class="border border-primary rounded position-relative vesitable-item">
                                <div class="vesitable-img">
                                    <img src="/client/img/vegetable-item-6.png" class="img-fluid w-100 rounded-top"
                                        alt="">
                                </div>
                                ...
                                <div class="p-4 rounded-bottom">
                                    <h4>At Our Store</h4>
                                    <p>Explore the latest in laptop technology with sleek designs, unmatched
                                        performance, and advanced features. Whether you’re a gamer, a professional, or a
                                        student, our collection offers something for everyone.</p>
                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                        <a href="#"
                                            class="btn border border-secondary rounded-pill px-3 text-primary"><i
                            ...
                            <div class="border border-primary rounded position-relative vesitable-item">
                                <div class="vesitable-img">
                                    <img src="/client/img/vegetable-item-1.png" class="img-fluid w-100 rounded-top"
                                        alt="">
                                </div>
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                    style="top: 10px; right: 10px;">Vegetable</div>
                            ...
                            <div class="border border-primary rounded position-relative vesitable-item">
                                <div class="vesitable-img">
                                    <img src="/client/img/vegetable-item-5.png" class="img-fluid w-100 rounded-top"
                                        alt="">
                                </div>
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                    style="top: 10px; right: 10px;">Vegetable</div>
                            ...
                            <div class="col-lg-6">
                                <div class="py-4">
                                    ...
                                    <p class="mb-4 text-dark">Explore the latest in laptop technology with sleek
                                        designs, unmatched performance, and advanced features. Whether you’re a gamer, a
                                        professional, or a student, our collection offers something for everyone.</p>
                                    <a href="#"
